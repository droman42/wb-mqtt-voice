# Irene — Release Journal archive: 2026-06-23 … 2026-07-02

Frozen per `one-active-journal` (rotated 2026-07-07). Append-only, never re-edited; the active
journal is [`docs/RELEASE_JOURNAL.md`](../../RELEASE_JOURNAL.md). Entries below are verbatim as
rotated — newest first; entries without a leading date are the pre-dated-prefix format
