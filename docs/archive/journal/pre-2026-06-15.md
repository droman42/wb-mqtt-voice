# Irene — Release Journal (archive: before 2026-06-15)

Frozen slice of [`../../RELEASE_JOURNAL.md`](../../RELEASE_JOURNAL.md) — sections dated **2026-05-31 … 2026-06-14**, rotated out to keep the active journal readable (Invariant #7).
**Append-only, never re-edited.** Same rules as the active journal: references task IDs, asserts no status.
