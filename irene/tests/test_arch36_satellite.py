...
from irene.satellite.link import SatelliteLink, SatelliteReplyClient, _frames
from irene.runners.satellite_runner import WAKE_ARM_WINDOW_S, _in_armed_window
from irene.runners.webapi_router import _client_cert_cn
...
async def test_provisioning_first_run_dance(tmp_path):
    ...
    from irene.satellite.provisioning import ensure_credentials
