...
from irene.config.models import AssetConfig, VADConfig
from irene.core.assets import AssetManager
from irene.providers.vad.silero import SileroVADProvider
from irene.utils.vad_silero import DEFAULT_SILERO_URL, SileroVADEngine
