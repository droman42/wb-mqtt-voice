...
from locveil_voice.core.client_registry import ClientRegistry, ActionRecord
...
class _RegistryPatch:
    ...
    def __enter__(self):
        ...
        self._p = patch("locveil_voice.intents.handlers.base.get_client_registry", return_value=self.reg)
        self._p.start()
        return self.reg
