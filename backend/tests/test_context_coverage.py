"""Characterization tests for ``locveil_voice.intents.context.ContextManager`` (TEST-7 Phase D).
...
from locveil_voice.intents.context import ContextManager
from locveil_voice.intents.context_models import RequestContext, UnifiedConversationContext
