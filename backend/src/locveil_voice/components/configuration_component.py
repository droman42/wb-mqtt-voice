    ...
    def get_router(self) -> APIRouter:
        ...
        async def get_section_schema(section_name: str):
            ...
            try:
                ...
                schema = AutoSchemaRegistry._extract_model_schema(section_model)
                return schema
            ...
            try:
                ...
                if not is_audio_available():
                    return AudioDevicesResponse(
                        ...
                        devices=[],
                        total_count=0,
                        message="Audio device detection not available. Install audio dependencies with: uv add locveil-voice[audio-input]"
                    )
